...
function checkArray(obj) {
	if (obj === null || obj === undefined ) {
		return "Помилка: Вхідний об'єкт є null або undefined.  false"
	}
...
function customFill(arr, value, start = 0, end = arr.length) {
  // Перевірка вхідних параметрів
  if ( !Array.isArray(arr) || arr.length < start || arr.length < end || start < 0 || end < 0) {
	return false}
  // якщо arr не масив повертаємо false
  ...
  let newArr = arr.fill(value, start, end)
  return newArr
